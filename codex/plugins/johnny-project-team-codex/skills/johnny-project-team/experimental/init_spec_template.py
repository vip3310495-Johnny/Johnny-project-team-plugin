...
# [AUTO-IMPLEMENTED] init_spec_template
# 此腳本由 Antigravity 共通框架自動生成，具備基礎 I/O 與 Log 拋轉能力。

def main():
    parser = argparse.ArgumentParser(description="init_spec_template 工具")
    ...
    print(f"[HOOK] init_spec_template 開始執行...")
    
    result_data = {
        "tool": "init_spec_template",
        "status": "SUCCESS",
    ...
    print(f"[GREEN LIGHT] init_spec_template 執行通過。")
    sys.exit(0)
