...
# [AUTO-IMPLEMENTED] user_story_validator
# 此腳本由 Antigravity 共通框架自動生成，具備基礎 I/O 與 Log 拋轉能力。

def main():
    parser = argparse.ArgumentParser(description="user_story_validator 工具")
    ...
    print(f"[HOOK] user_story_validator 開始執行...")
    
    result_data = {
        "tool": "user_story_validator",
        "status": "SUCCESS",
    ...
    print(f"[GREEN LIGHT] user_story_validator 執行通過。")
    sys.exit(0)
